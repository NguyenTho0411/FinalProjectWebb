...
public class PaymentServices {
    ...
    private static final String CLIENT_ID = "ASUcx7xp9dW7kF4I4-cq0kwLHIY_J5Ztrio2hNSEjT3-C1zsBj8oJTSk_ECfOZ0XonnEJP8S-hf3lN3L";
    private static final String CLIENT_SECRET = "EMkpK3DnTzH4zvniHBgBllZ66OZO04vr5bf-KeH87gR0lLUZB0Axkx8IV02PmiILPpJoDNytbAJBjBY2";
    ...
    private List<Transaction> getTransactionInformation(BookOrder order) {
        ...
        transaction.setDescription("Books ordered on THQT Books");
    ...
    public Payment executePayemnt() throws PayPalRESTException {
       		String paymentId = request.getParameter("paymentId");
		String payerId = request.getParameter("PayerID");
